...
<%@ include file="headerAndSideBar.jsp" %>
        ...
        <s:form action="AddNewParent">
        <div>
            <div class="row text-center">
                <h2>Add Parent Details for Student:<s:property value="tempStudentID"/></h2>
                 <s:hidden name="tempStudentID" value="%{tempStudentID}" />
            </div>
            ...
            <div class="col-md-12" style="margin-bottom:10px">
            	...
            	<div class="col-md-3">
            		<select required="required" class="form-control" name="relation" id="relation">
            ...
            <div>
                <div class="col-md-12" style="margin-bottom:10px">
                    ...
                    <div class="col-md-5">
                        <input type="email" required="required" class="form-control" name="emailID" id="emailID" placeholder="Enter email address">
                        <p class="help-block">
